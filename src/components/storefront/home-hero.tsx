...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-oud-ivory">
      ...
      <Container className="relative grid min-h-[calc(100svh-4rem)] items-center gap-10 py-10 md:grid-cols-[1.05fr_0.95fr] md:py-14">
        <div className="space-y-6">
          ...
          <div className="space-y-5">
            <h1 className="font-display text-4xl font-bold leading-tight text-oud-brown md:text-6xl">
              فخامة العود والبخور بروح عربية هادئة
            </h1>
            <p className="max-w-xl text-base leading-8 text-oud-muted md:text-lg">
        ...
        <div className="relative">
          <div className="rounded-oud border border-oud-gold/25 bg-gradient-to-br from-oud-brown via-oud-coffee to-oud-gold p-4 shadow-gold">
            <div className="relative min-h-[28rem] overflow-hidden rounded-oud border border-white/15 bg-[radial-gradient(circle_at_35%_25%,rgba(255,252,246,0.22),transparent_28%),linear-gradient(145deg,rgba(54,31,20,0.1),rgba(54,31,20,0.55))] p-6">
